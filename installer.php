...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'potencial_infinito_b8498b5cd1a586d77517_20210816185631_archive.zip';
	const ARCHIVE_SIZE		 = '64327261';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b8498b5-16185631';
    const SECONDARY_PACKAGE_HASH = '85fabab-16185631';
	const VERSION			 = '1.4.2';
